...
export default (task) => html`
  <div class="grid grid-cols-4 gap-3 w-full">
    <div>
      ...
      <label for="window" class="${css.radio}"> Окно </label>
    </div>
    ...
    <div>
      ...
      <label for="deadline" class="${css.radio}"> Срок </label>
    </div>
    ...
    <div>
      <input
        ...
        value="meeting"
        class="hidden peer"
        ${checked(task, "meeting")} />
      <label for="meeting" class="${css.radio}"> Встреча </label>
    </div>
  </div>
`
