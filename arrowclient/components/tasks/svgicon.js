...
export const taskStatusIcon = (kind) => {
  if (kind === "pause") {
    return html`<svg class="w-2.5" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
  ...
  if (kind === "ready") {
    return html`<svg class="w-2.5" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
