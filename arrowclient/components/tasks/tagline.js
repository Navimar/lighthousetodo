            ...
            ${() =>
              assignedIds?.map((collaboratorId) => {
                if (
                  ...
                  return html`<div
                    class="text-neutral-700 dark:text-neutral-350 px-3 py-2 mx-1 inline-block align-middle rounded-lg bg-neutral-150 dark:bg-neutral-800">
            ...
            ${() =>
              mainTasks.map((task) => {
                ...
                return html`<div
                  ...
                  class="${cornerbox} text-neutral-700 dark:text-neutral-350 px-3 py-1 mx-1 inline-block align-middle rounded-lg border border-neutral-150 dark:border-neutral-800 bg-neutral-150 dark:bg-neutral-800">
          ...
          ${() =>
            importantTasks.map((task) => {
              ...
              return html`<div
                ...
                class="${cornerbox} text-neutral-700 dark:text-neutral-350 px-3 py-1 mx-1 inline-block align-middle rounded-lg border border-neutral-150 dark:border-neutral-800">
                <div class="flex h-full items-center"
                  ><div class="break-word">${task.name}</div>${() => taskplate(task, "text-xxs ml-auto")}</div
                ></div
              >`
