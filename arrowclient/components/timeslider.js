...
<div id="currentTimeMarker" style="left:${currentTime.slider}px" class="relative top-7 h-0 z-40 text-xs w-0 flex flex-col items-center dark:text-darkold text-old text-center">
