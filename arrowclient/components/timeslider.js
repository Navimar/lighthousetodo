...
import { adjustDate } from '/components/manipulate.js'
...
<div id="currentTimeMarker" style="left:${currentTime.slider}px" class="relative top-7 h-0 z-50 text-xs w-0 flex flex-col items-center dark:text-darkold text-old text-center">
  <span class="font-bold">|</span>
  <span class="notomono font-bold rounded-lg px-2 bg-lightgray dark:bg-darkold dark:text-lightgray block">${() => currentTime.clock}</span>
</div>
...
<div class="w-full  px-3.5 flex justify-between text-xs dark:text-white text-mygray">
...
<div class="w-full flex justify-between text-xs dark:text-white text-darkgray">
 <div class="flex flex-col items-center">
