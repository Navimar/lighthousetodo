export default {
  button:
    "fontaccent uppercase text-base text-clip overflow-hidden p-1 text-black dark:text-neutral-100 bg-neutral-150 dark:bg-neutral-700 text-center block border-white dark:border-black rounded-0 border-b-02rem peer-checked:border-b-02rem peer-checked:border-accent peer-checked:bg-neutral-150 dark:peer-checked:bg-neutral-700  dark:peer-checked:border-accent-dark active:border-b-accent dark:active:border-b-accent-dark active:border-b-accent dark:active:border-b-accent-dark",
  ...
  radio:
    "fontaccent uppercase text-base text-clip overflow-hidden w-full p-1 text-black dark:text-neutral-100 border-white dark:border-black border-b-02rem text-center block cursor-pointer bg-neutral-50 dark:bg-neutral-800 peer-checked:border-accent peer-checked:bg-neutral-50 dark:peer-checked:bg-neutral-800  dark:peer-checked:border-accent-dark active:border-b-accent dark:active:border-b-accent-dark active:border-b-accent dark:active:border-b-accent-dark",
}
